  ...
  return (
    ...
    < div className="bg-black ">
      <div className="flex flex-col  gap-5 bg-[#151515] items-center ">
          <div key={data.id} className="container-full mb-[50px]  w-[550px] h-[700px] mt-[50px]  rounded-[30px] bg-black mx-auto relative flex justify-center">
            <section className="container  bg-black items-center justify-center rounded-[50px] px-8 py-8 flex flex-col">
              <p className="text-warning font-black text-7xl pb-2 mt-5">{data.title}</p>
