...
const productos = [
  ...
  {id: 7, title:"VAT 69", description: "Whisky", price:2280,  stock:9,  foto: 'https://i.ibb.co/N9j6h1c/VAT-69-Whisky.png',categoria: 'whisky'},
  {id: 8, title:"TANQUERRAY", description: "London Dry Gin", price:2280, stock:9, foto: 'https://i.ibb.co/hRpvrhr/tanqueray-london-dry-gin.png',categoria: 'spirits'},
  {id: 9, title:"TANQUERRAY", description: "Flor de Sevilla", price:2280, stock:9, foto: 'https://i.ibb.co/L9j6zzV/tanqueray-flor-de-sevilla-gin.png',categoria: 'spirits'},
  {id: 10, title:"BAILEYS", description: "Aperitive Caramel", price:2280, stock:9,  foto: 'https://i.ibb.co/FK7X2sK/baileys.png',categoria: 'aperitive'},
  {id: 11, title:"SMIRNOFF", description: "Vodka Green Apple ", price:1880, stock:19, foto: 'https://i.ibb.co/mC9Dvxv/smirnoff-apple.png',categoria: 'spirits'},
  ...
  {id: 13, title:"ZACAPA",  description: "Ron Deliz Victory", price: 21880,  stock:19, foto: 'https://i.ibb.co/qN48MP7/ron-deliz-zacapa.png',categoria: 'spirits'},
  ...
  {id: 15, title:"CARDHU", description: "Whisky Aged 20 Year", price: 12880, stock:19, foto: 'https://i.ibb.co/jwgDDPT/cardhu.png',categoria: 'whisky'},
  {id: 16, title:"BUCANANS", description: "Whisky Deluxe", price: 12880, stock:19, foto: 'https://i.ibb.co/cFQRMQk/bucanans-delixe-whisky.png',categoria: 'whisky'},
